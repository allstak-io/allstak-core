 ...
 *
 * The concrete implementation lives in `allstak-js`. This package keeps it
 * separated by a stable public surface so platform packages can depend on
 * `@allstak/core` without pulling browser/React code.
 */
export {
  AllStak,
  type AllStakConfig,
